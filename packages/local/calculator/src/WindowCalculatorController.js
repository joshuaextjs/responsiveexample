Ext.define('calculator.WindowCalculatorController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.windowcalculatorcontroller',
    ...
    onClickOK: function (){
        var vm = this.getViewModel();
        this.fireViewEvent("oknumber", this, vm.get("display"));
    }
});